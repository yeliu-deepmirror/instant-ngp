...
# won't install realsense by default
# COPY installers/realsense.sh /tmp/installers/
# RUN bash /tmp/installers/realsense.sh /tmp/build && rm /tmp/installers/realsense.sh
